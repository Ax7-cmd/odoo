...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("ScolabsBeforeTestHook", "ScolabsAfterTestHook"); // Scolabs customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("ScolabsBeforeTestHook"); // Scolabs customization
  	...
  	finish: async function finish() {
  		...
  		emit("ScolabsAfterTestHook", this);
